...
class MLPPolicySL(BasePolicy, nn.Module, metaclass=abc.ABCMeta):
    ...
    def forward(self, observation: torch.FloatTensor) -> Any:
        ...
        action = distributions.Normal(mean, self.logstd.exp()).rsample()
    ...
    def update(self, observations, actions):
        ...
        # TODO: conver obs and acts to torch
        loss = F.mse_loss(self.forward(ptu.from_numpy(observations)), ptu.from_numpy(actions))
